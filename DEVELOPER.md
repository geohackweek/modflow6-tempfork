...
| ubuntu-20.04 | &check;         | &check;         |              |              | &check;        | &check;        |             | &check;                       | &check;                        | &check;                       |                            | &check;                       | &check;                       | &check;                       | &check;                       | &check;                       | &check;                       |                    |                    |                    |                    |                    | &check;                 | &check;               |                    |                    | &check;               |
...
| ubuntu-20.04 | &check;         | &check;         |              |              | &check;        | &check;        |             | &check;                       |                             | &check;                       |                            | &check;                       | &check;                       | &check;                       | &check;                       |                            |                            |                    |                    |                    |                    |                    |                      |                    |                    |                    |                    |
